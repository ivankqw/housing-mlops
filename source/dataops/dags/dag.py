...
from extract_datagovsg import extract_datagovsg_data_task
from extract_ura import extract_ura_data_task
from transform_datagovsg import transform_districts_task, transform_resale_flat_transactions_task
...
def property_pipeline():
    ...
    # Transform
    data_path_private_transactions = transform_private_transactions_task(data_path_private_transactions)
